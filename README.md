...
| `--category` | | Render only one built-in skill category |
...
Category targets can also be baked directly:
...
Or use the category filter with any target:
...
Lists built-in skill categories that can be used with `skcr bake --category`.
